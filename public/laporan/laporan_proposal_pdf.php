...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        thead th { padding: 8px 6px; text-align: left; font-size: 8pt; font-weight: 600; text-transform: uppercase; border: 1px solid #5b21b6; }
...
<body>
    ...
    <div class="info-box">
        ...
        <p><strong>Total data:</strong> <?= $totalSurat ?> proposal</p>
    </div>
    ...
    <div class="stats-grid">
        <div class="stat-row">
            ...
            <div class="stat-cell red">
                ...
                <div class="value"><?= $byStatus['ditolak'] ?? 0 ?></div>
            </div>
        </div>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr><td colspan="6" class="text-center">Tidak ada data proposal untuk periode ini</td></tr>
            <?php else: ?>
