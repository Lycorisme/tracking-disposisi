...
// Base Query Condition (Proposal id_jenis = 3)
$whereClause = "WHERE s.id_jenis = 3 AND DATE(s.tanggal_surat) BETWEEN ? AND ?";
    ...
    <div class="flex-1 lg:ml-64">
        <main class="p-4 sm:p-6 lg:p-8">
            ...
            <div class="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 class="text-xl sm:text-2xl font-bold text-gray-800 mb-2">Laporan Proposal</h1>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4 mb-6">
                <div class="bg-white rounded-lg shadow p-3 sm:p-4 border-l-4 border-gray-600">
                    <p class="text-xs sm:text-sm text-gray-600 mb-1">Total Proposal</p>
                ...
                <div class="bg-white rounded-lg shadow p-3 sm:p-4 border-l-4 border-green-500">
                    ...
                    <p class="text-xl sm:text-2xl font-bold text-green-600"><?= $byStatus['disetujui'] ?? 0 ?></p>
                </div>
                <div class="bg-white rounded-lg shadow p-3 sm:p-4 border-l-4 border-red-500 col-span-2 sm:col-span-3 lg:col-span-1">
                    <p class="text-xs sm:text-sm text-gray-600 mb-1">Ditolak</p>
                    <p class="text-xl sm:text-2xl font-bold text-red-600"><?= $byStatus['ditolak'] ?? 0 ?></p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden">
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-10 text-center text-gray-500">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p>Tidak ada data proposal untuk periode ini</p>
                                    </div>
                                </td>
                            </tr>
                            <?php else: ?>
                ...
                <div class="bg-gray-50 border-t border-gray-200 print:hidden">
                    <?= $pagination->render(BASE_URL . '/public/laporan/laporan_proposal.php', $_GET) ?>
                </div>
            </div>
