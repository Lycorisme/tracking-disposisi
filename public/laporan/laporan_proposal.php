        ...
        <main class="p-6 lg:p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
                <div class="bg-white rounded-lg shadow p-4">
                    <p class="text-sm text-gray-600 mb-1">Total Proposal</p>
                ...
                <div class="bg-white rounded-lg shadow p-4">
                    ...
                    <p class="text-2xl font-bold text-red-600"><?= $byStatus['ditolak'] ?? 0 ?></p>
                </div>
            </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                <td colspan="6" class="px-4 py-8 text-center text-gray-500">Tidak ada data proposal untuk periode ini</td>
                            </tr>
                            <?php else: ?>
